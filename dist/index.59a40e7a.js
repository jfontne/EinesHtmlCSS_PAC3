...
(0, _categoriesJsonDefault.default).forEach((cat)=>{
    let opcio = document.createElement("option");
...
despCat.addEventListener("change", (event)=>{
    let cat = (0, _categoriesJsonDefault.default).find((x)=>x.titulo === event.target.value);
    location.href = `categoria.html?cat=${cat.id}`;
});

},{"../data/categories.json":"jsTyj","../data/grups.json":"8SG4D","swiper":"cCbRx","swiper/swiper-bundle.css":"aErfw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jsTyj":[function(require,module,exports) {
...
},{}],"8SG4D":[function(require,module,exports) {
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aErfw":[function() {},{}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequire1f3a")
