...
})({"6wJOT":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "fa28e5c29ba3e976";
...
},{}],"bmnj6":[function(require,module,exports) {
...
var categoria = (0, _categoriesJsonDefault.default).filter((x)=>x.id === IdCat);
...
const songsCat = (0, _songsJsonDefault.default).filter((x)=>x.categoria.some((xx)=>xx === categoria[0].id));
...
},{}]},["6wJOT","bmnj6"], "bmnj6", "parcelRequire1f3a")

//# sourceMappingURL=categoria.9ba3e976.js.map
