...
var _grupsJson = require("../data/grups.json");
...
(0, _grupsJsonDefault.default).forEach((grup)=>{
    let divGrup = document.createElement("div");
    divGrup.className = "grup";
    let imgGrup = document.createElement("img");
    imgGrup.className = "grup";
    imgGrup.src = `img/grups/${grup.fotoGrup}`;
    let titolGrup = document.createElement("h1");
    titolGrup.innerText = grup.nom;
    divGrup.append(imgGrup);
    divGrup.append(titolGrup);
    containerGrup.append(divGrup);
}); //containerGrup.append(ulGrup);

},{"../data/categories.json":"jsTyj","swiper":"cCbRx","swiper/swiper-bundle.css":"aErfw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../data/grups.json":"8SG4D"}],"jsTyj":[function(require,module,exports) {
